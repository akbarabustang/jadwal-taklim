    ...
    <AdminLayout>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mt-2">Edit Jadwal Taklim</h1>
                <p class="text-gray-600 mt-1">Perbarui informasi jadwal kajian</p>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-8 flex items-center justify-end space-x-3">
                    ...
                    >
                        {{ form.processing ? 'Menyimpan...' : 'Update Jadwal' }}
                    </button>
                </div>
            </form>
        </div>
...
const form = useForm({
    ...
    ustad_name: props.schedule.ustad_name,
    mosque_name: props.schedule.mosque_name,
    mosque_address: props.schedule.mosque_address,
    mosque_city: props.schedule.mosque_city,
    ...
    contact_person: props.schedule.contact_person,
    contact_number: props.schedule.contact_number,
